          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <h1 className="text-[45px] relative -left-3 -top-5">
                  AgriSpace
                </h1>
              </Link>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <h2 className="mb-5 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign In to AgriSpace
              </h2>

              <div className="flex items-center justify-between w-[300px] mx-auto mb-4">
                <Link
                  to="#"
                  ...
                  <div className="relative">
                    ...
                    <span className="absolute right-4 top-4">
                      <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                      ></svg>
                      <IoPersonOutline className="text-[23px] opacity-55 relative -top-5" />
                    </span>
                  </div>
                </div>
