...
import { MdProductionQuantityLimits } from 'react-icons/md';
import { IoWaterOutline } from 'react-icons/io5';
import { logout } from '../../ApiUtils/apiUtils';
>>>>>>> Stashed changes
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
...
=======
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 text-[40px] text-green-400 mb-4 relative left-[26px] top-3">
>>>>>>> Stashed changes
        <NavLink to="/">
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    isActive
                      ? `group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 bg-graydark dark:bg-meta-4`
